...
import (
	...
	"github.com/Chen-Si-An/Autoscaling/MongoDBOperator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "10bfefa9.mongodb.io",
	...
	if err := (&controller.MongosAutoscalerReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "MongosAutoscaler")
		os.Exit(1)
	}
	if err := (&controller.MongodAutoscalerReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "MongodAutoscaler")
		os.Exit(1)
	}
